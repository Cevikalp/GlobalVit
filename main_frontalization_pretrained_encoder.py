...
from myutils.git_models import ViTFrontalizationEncoderDecoderLast, Discriminator, ViTFrontalizationEncoderDecoderPretrained # Assume you save the model in this file
...
if LOAD_MODEL:
    model.load_state_dict(torch.load("/media/mlcv/SSD/outputs_pretrained_encoder/model_epoch_17.pth"))
    Disc.load_state_dict(torch.load("/media/mlcv/SSD/outputs_pretrained_encoder/disc_model_epoch_17.pth"))
...
def main(args):
# --- Training Loop ---
    output_dir = Path("/media/mlcv/SSD/outputs_pretrained_encoder") 
